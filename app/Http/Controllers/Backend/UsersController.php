...
class UsersController extends Controller
{
    ...
    public function store(Requests\StoreUserRequest $request)
    {
        ...
        return redirect(route('backend.users.index'))->with('status', 'New User has been created.');   
    }
    ...
    public function update(Requests\UpdateUserRequest $request, $id)
    {
        ...
        return redirect(route('backend.users.edit', $user->id))->with('status', 'User name: ' . $user->name . ' has been updated.');
    }
