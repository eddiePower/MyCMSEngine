...
@section('title', $page->exists ? 'Editing ' . $page->title : 'Creating New Page')
...
<div class="checkbox">
	<label>
		...
		<span class="help-block">
			Checking this will hide the page from the navigation bars. Can only be applied to pages without children or subpages.
		</span>
	</label>
</div>

{!! Form::submit($page->exists ? 'Update Page' : 'Create New Page', ['class' => 'btn btn-primary']) !!}
