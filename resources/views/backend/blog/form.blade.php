...
@section('content')
	...
	{!! Form::model($post, [
		...
		{{-- Mark Down Editor like WYSIWYG editor --}}
		<script>
			new SimpleMDE({
			...
			new SimpleMDE({
				...
				$('input[name=title]').on('blur', function () {
						...
						//Automattic generation of a slug tag with all lower case and any non alpha chars replaced with - and also any - stripped away from start of finish.
